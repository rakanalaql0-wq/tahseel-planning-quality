...
const PATHS = {
  ...
  shield: '<path d="M12 3 4 6v5.5c0 4.5 3.3 8.4 8 9.5 4.7-1.1 8-5 8-9.5V6Z"/><path d="m9 12 2 2 4-4"/>',
  scale: '<path d="M12 3v18M7 21h10"/><path d="M12 6 5 9M12 6l7 3"/><path d="M2 14a3 3 0 0 0 6 0L5 9Z"/><path d="M16 14a3 3 0 0 0 6 0l-3-5Z"/>',
  layers: '<path d="m12 3 9 5-9 5-9-5Z"/><path d="m3 13 9 5 9-5"/>',
  flag: '<path d="M5 21V4"/><path d="M5 4h11l-1.6 3.5L16 11H5Z"/>',
...
/**
 * خريطة الكلمة → الأيقونة.
 * تُستنتج أيقونة كل عنوان قسم من نصّه، فلا يبقى قسم بلا أيقونة
 * ولا يُضطر كل نداء إلى تمريرها يدويًا.
 */
const TITLE_ICONS = [
  [/^إنشاء|^إضافة|^تسجيل |جديد$/, 'plus'],
  [/شجرة المقياس|المقياس|الدرجة|درجات/, 'scale'],
  [/اللقاء|الجلسات/, 'sessions'],
  [/الطلاب|الطالب|المستفيد/, 'students'],
  [/الحضور|الغياب/, 'attendance'],
  [/الخطة|المحتوى|المنهج/, 'plan'],
  [/المعلم|المعلّم|المدرّب/, 'teacher'],
  [/النشاط|الأنشطة|الفعالي/, 'activity'],
  [/الاستبان/, 'survey'],
  [/الأثر|التحسّن|التحسن/, 'impact'],
  [/الشكاو|الشكوى/, 'complaint'],
  [/الانضباط|السلوك/, 'discipline'],
  [/الاستمرار|التسرّب|التسرب/, 'continuity'],
  [/الإجراء|الإجراءات|المعالجة/, 'actions'],
  [/الفريق|الأدوار|الإسناد/, 'team'],
  [/التدقيق|سجل/, 'audit'],
  [/إقفال|الإغلاق/, 'closeProgram'],
  [/المقارنة|المعايرة|المتوسط|الفترات|الاتجاه/, 'reports'],
  [/التقرير|التقارير/, 'reports'],
  [/انتباه|ملاحظات|تحذير|إنذار|خطر|تدخّل|تدخل/, 'alert'],
  [/ابدأ|الأولوي|الأهم|التوصية/, 'sparkle'],
  [/الشواهد|شاهد|المرفق/, 'file'],
  [/التنبيه/, 'bell'],
  [/المستخدم|الحسابات/, 'users'],
  [/البرامج|البرنامج/, 'programs'],
  [/الواجب|المهام|المهمة/, 'tasks'],
  [/القاعة|القاعات|المرافق|البيئة|المقر/, 'building'],
  [/الجودة|المؤشر|المؤشرات/, 'target'],
  [/الموعد|التوقيت|المدة|الزمن/, 'clock'],
  [/التحقق|قائمة/, 'check'],
  [/الجمعية|عن/, 'shield'],
];

/** يستنتج أيقونة مناسبة من نص العنوان. */
